<?php
    ...
    if(isset($_GET['txtID'])){
        ...
        $sentencia=$conect->prepare("SELECT foto,cv FROM tbl_empleados WHERE id=:id");
        ...
        $sentencia=$conect->prepare("DELETE FROM tbl_empleados WHERE id=:id");
        $sentencia->bindParam(":id",$txtID);
        $sentencia->execute();
    ...
    $sentencia = $conect->prepare("SELECT *,
